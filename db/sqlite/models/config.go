...
type Config struct {
	...
	PrivacyMode            db.PrivacyMode `boil:"privacyMode" json:"privacyMode" toml:"privacyMode" yaml:"privacyMode"`
...
type whereHelperdb_PrivacyMode struct{ field string }

func (w whereHelperdb_PrivacyMode) EQ(x db.PrivacyMode) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.EQ, x)
}
func (w whereHelperdb_PrivacyMode) NEQ(x db.PrivacyMode) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.NEQ, x)
}
func (w whereHelperdb_PrivacyMode) LT(x db.PrivacyMode) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LT, x)
}
func (w whereHelperdb_PrivacyMode) LTE(x db.PrivacyMode) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LTE, x)
}
func (w whereHelperdb_PrivacyMode) GT(x db.PrivacyMode) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GT, x)
}
func (w whereHelperdb_PrivacyMode) GTE(x db.PrivacyMode) qm.QueryMod {
