...
type Member struct {
	...
	PubKey db.DBFeedRef `boil:"pub_key" json:"pub_key" toml:"pub_key" yaml:"pub_key"`
...
var MemberRels = struct {
	...
	SIWWEB3RSessions:             "SIWWEB3RSessions",
	Aliases:                      "Aliases",
...
type memberR struct {
	...
	SIWWEB3RSessions             SIWWEB3RSessionSlice    `boil:"SIWWEB3RSessions" json:"SIWWEB3RSessions" toml:"SIWWEB3RSessions" yaml:"SIWWEB3RSessions"`
...
func (r *memberR) GetFallbackPassword() *FallbackPassword {
	if r == nil {
		return nil
	}
	return r.FallbackPassword
}

func (r *memberR) GetSIWWEB3RSessions() SIWWEB3RSessionSlice {
	if r == nil {
		return nil
	}
	return r.SIWWEB3RSessions
}

func (r *memberR) GetAliases() AliasSlice {
	if r == nil {
		return nil
	}
	return r.Aliases
...
func (r *memberR) GetForMemberFallbackResetTokens() FallbackResetTokenSlice {
	if r == nil {
		return nil
	}
	return r.ForMemberFallbackResetTokens
}

func (r *memberR) GetCreatedByFallbackResetTokens() FallbackResetTokenSlice {
	if r == nil {
		return nil
	}
	return r.CreatedByFallbackResetTokens
}

func (r *memberR) GetCreatedByInvites() InviteSlice {
	if r == nil {
		return nil
	}
	return r.CreatedByInvites
}
...
func (o *Member) FallbackPassword(mods ...qm.QueryMod) fallbackPasswordQuery {
	...
	return FallbackPasswords(queryMods...)
}

// SIWWEB3RSessions retrieves all the SIWWEB3R_session's SIWWEB3RSessions with an executor.
func (o *Member) SIWWEB3RSessions(mods ...qm.QueryMod) sIWWEB3RSessionQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"SIWWEB3R_sessions\".\"member_id\"=?", o.ID),
	)

	return SIWWEB3RSessions(queryMods...)
}
...
func (o *Member) ForMemberFallbackResetTokens(mods ...qm.QueryMod) fallbackResetTokenQuery {
	...
	return FallbackResetTokens(queryMods...)
}
...
// LoadSIWWEB3RSessions allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (memberL) LoadSIWWEB3RSessions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeMember interface{}, mods queries.Applicator) error {
	var slice []*Member
	var object *Member
	...
	query := NewQuery(
		qm.From(`SIWWEB3R_sessions`),
		qm.WhereIn(`SIWWEB3R_sessions.member_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return errors.Wrap(err, "failed to eager load SIWWEB3R_sessions")
	}

	var resultSlice []*SIWWEB3RSession
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice SIWWEB3R_sessions")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on SIWWEB3R_sessions")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for SIWWEB3R_sessions")
	}
	...
	if singular {
		object.R.SIWWEB3RSessions = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &sIWWEB3RSessionR{}
			}
			foreign.R.Member = object
		}
		return nil
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.MemberID {
				local.R.SIWWEB3RSessions = append(local.R.SIWWEB3RSessions, foreign)
				if foreign.R == nil {
					foreign.R = &sIWWEB3RSessionR{}
				}
				foreign.R.Member = local
...
// AddSIWWEB3RSessions adds the given related objects to the existing relationships
// of the member, optionally inserting them as new records.
// Appends related to o.R.SIWWEB3RSessions.
// Sets related.R.Member appropriately.
func (o *Member) AddSIWWEB3RSessions(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*SIWWEB3RSession) error {
	var err error
	...
	if o.R == nil {
		o.R = &memberR{
			SIWWEB3RSessions: related,
		}
	} else {
		o.R.SIWWEB3RSessions = append(o.R.SIWWEB3RSessions, related...)
	}

	for _, rel := range related {
		if rel.R == nil {
			rel.R = &sIWWEB3RSessionR{
				Member: o,
			}
		} else {
			rel.R.Member = o
