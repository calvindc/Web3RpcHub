...
CREATE INDEX invite_active_ids ON invites(id);
CREATE UNIQUE INDEX invite_active_tokens ON invites(hashed_token);
...
-- public keys that should never ever be let into the hub
