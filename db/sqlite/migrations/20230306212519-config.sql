...
-- the configuration settings for this hub, currently privacy mode settings and the default translation for the hub
CREATE TABLE config (
...
-- the config table will only ever contain one row: the hubs current settings
